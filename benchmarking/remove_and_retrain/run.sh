...
python3 get_performance.py --dataset simulated_2 --interaction_type integrated_hessians --visible_devices 4 --train_interaction_model;
read;
'
tmux new-session -d -s s2_eh '
python3 get_performance.py --dataset simulated_2 --interaction_type expected_hessians --visible_devices 4;
read;
'
tmux new-session -d -s s2_hs '
python3 get_performance.py --dataset simulated_2 --interaction_type hessians --visible_devices 4;
read;
'
tmux new-session -d -s s2_hti '
python3 get_performance.py --dataset simulated_2 --interaction_type hessians_times_inputs --visible_devices 4;
read;
'
tmux new-session -d -s s2_ss '
python3 get_performance.py --dataset simulated_2 --interaction_type shapley_sampling --visible_devices 4;
read;
'
tmux new-session -d -s s2_cd '
python3 get_performance.py --dataset simulated_2 --interaction_type contextual_decomposition --visible_devices 4;
read;
'
tmux new-session -d -s s2_nid '
python3 get_performance.py --dataset simulated_2 --interaction_type neural_interaction_detection --visible_devices 4;
read;
'
